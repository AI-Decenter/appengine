...
pub struct Artifact { pub id: Uuid, pub app_id: Option<Uuid>, pub digest: String, pub size_bytes: i64, pub signature: Option<String>, pub sbom_url: Option<String>, pub manifest_url: Option<String>, pub verified: bool, pub created_at: DateTime<Utc> }
